...
<head>
    ...
    <title>About</title>
        ...
        <link rel="stylesheet" href="assets/css/plugins/responsive.css">
         <!--=====FAV-ICoN=======-->
         <link rel="shortcut icon" href="assets/images/logo/favicon3.png"/>
     <!--=====JQUERY=======-->
     ...
     <div id="pre-load">
      <div id="loader" class="loader">
          <div class="loader-container">
              <div class="loader-icon"><img src="assets/images/logo/logos11.png" alt=" "></div>
          </div>
      </div>              
  </div>
  <!--=====preloader end=======-->
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="welcomeaboiut2 text-center">
                <h1 class="font-lora font-60 lineh-64 weight-500 color margin-b24">About US</h1>
                <p class="font-20 weight-500 font-ks lineh-20 color"><a href="index.php" class="color">Home</a><span><i class="fa-solid fa-angle-right"></i></span> About Us</p>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="about3-images1">
          ...
          <img src="assets/images/elementor/elementor17.png" alt="" class="elementor-9 keyframe3">
        </div>
      </div>
      <div class="col-lg-6">
        <div class="about3-textarea1">
          ...
          <h1 class="font-lora font-48 lineh-56 weight-600 color-29 margin-b20">Hi, I Am Admire!</h1>
          <p class="font-ks font-16 lineh-26 weight-500 color-30 ">A Chartered Certified Accountant and a member of the South African Auditor General. I had more than thirteen years of working experience (regionally and internationally) in the field of accounting, business rescue and auditing. I had experience from a wide diverse background of sectors including manufacturing, oil and gas, service, public and private sector and retail to mention just a few. My auditing career culminated in me holding the position of Group Assistant Audit manager in Qatar, and my accounting career with holding the position of Group Finance Manager. I am in charge of financial management, internal compliance and risk management of our company.</p>
        ...
        <a href="about.php" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">About Us <span><i class="fa-solid fa-arrow-right"></i></span></a>
      </div>
      </div>
    </div>
  </div>
...
<div class="lawprovide-section-area section-padding5">
    <img src="assets/images/elementor/elementor23.png" alt="" class="elementor24">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="lawprovide-textarea">
                    <h1 class="font-lora font-48 lineh-56 weight-600 color-29 margin-b20">WE ARE “ CTA”
                      PROVIDE BEST TAX SOLUTION</h1>
                    <p class="font-ks font-16 weight-500 lineh-26 margin-b20 color-30">We are committed to our clients’ sustainable growth. We provide a wide range of services to our clients, specialising in audit, accountancy and tax advisory services. <br>

                      Stay on Top : Having a private accountant can help you stay on top of your tax matters.
                      
                    </p>
                    <p class="font-ks font-16 weight-500 lineh-26 color-30">  Save Time : You don’t have to do all the tasks yourself, we can help you deal with the company’s most important obligations.</p>
                    <a href="team.php" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Meet Our Attorneys <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="lawprovide-boaxrea margin-b30">
                    <div class="guidiance-boxarea">
                        <img src="assets/images/icons/gudeiance1.svg" alt="" class="ts">
                    </div>
                    <div class="lax-conultingprovide">
                        <a href="#" class="color-29"><h1 class="font-lora font-24 lineh-24 weight-600 color-29 margin-b14 ts">Personal Legal Guidance</h1></a>
                ...
                <div class="lawprovide-boaxrea margin-b30">
                    <div class="guidiance-boxarea">
                        <img src="assets/images/icons/consulting1.svg" alt="" class="ts">
                    </div>
                    <div class="lax-conultingprovide">
                        <a href="#" class="color-29"><h1 class="font-lora font-24 lineh-24 weight-600 color-29 margin-b14 ts">Business Strategy Consulting</h1></a>
                        <p class="font-ks lineh-26 weight-500 color-30 font-16 ts">CTA Tax and Business Services is an accounting firm that provides various services in the broad accounting and financing field. </p>
                    </div>
                </div>
                ...
                <div class="lawprovide-boaxrea">
                    <div class="guidiance-boxarea">
                        <img src="assets/images/icons/support1.svg" alt="" class="ts">
                    </div>
                    <div class="lax-conultingprovide">
                        <a href="#" class="color-29"><h1 class="font-lora font-24 lineh-24 weight-600 color-29 margin-b14 ts">Litigation Support</h1></a>
                        <p class="font-ks lineh-26 weight-500 color-30 font-16 ts">CTA provides a multitude of services to a wide variety of clients from its presence in Pretoria.</p>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <img src="assets/images/elementor/elementor23.png" alt="" class="elementor25">
</div>
<!--===== LAW PROVIDE END=======-->
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="missionimg">
                    <img src="assets/images/sectionimg/missionimg1.png" alt="" class="missionimg2">
                    <img src="assets/images/elementor/elementor17.png" alt="" class="elementor-9 keyframe3">
                </div>
            </div>
            <div class="col-lg-6">
                <div class="missiontextarea">
                    <h1 class="font-lora font-48 lineh-56 weight-600 color-29 margin-b20">Our Vision</h1>
                    <p class="font-ks font-16 lineh-26 weight-500 color-30 margin-b">is to be identified as the best professional service organization that enable our clients and our People to achieve the desired balance between personal, professional and financial success.</p>
                    ...
                    <ul>
                        <li class="font-ks font-16 lineh-16 weight-600 color-17 margin-b20"><span><img src="assets/images/icons/check1.png" alt=""></span>Client-Focused Solutions and Results</li>
                        <li class="font-ks font-16 lineh-16 weight-600 color-17 margin-b20"><span><img src="assets/images/icons/check1.png" alt=""></span>Flexible, Value Driven Approach</li>
                        <li class="font-ks font-16 lineh-16 weight-600 color-17 margin-b20"><span><img src="assets/images/icons/check1.png" alt=""></span>Warning of updated legal risks for customers</li>
                        <li class="font-ks font-16 lineh-16 weight-600 color-17"><span><img src="assets/images/icons/check1.png" alt=""></span>A team of experienced and highly specialized</li>
                    </ul>
                    <a href="services.php" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Learn More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
        </div>
    </div>
                  ...
                  <div class="nav-section-area">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                          <button class="nav-link active nav-btn1" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Our Mission</button>
                        </li>
                        <li class="nav-item" role="presentation">
                          <button class="nav-link nav-btn1" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Our Values</button>
                        </li>
                        <li class="nav-item" role="presentation">
                      ...
                      <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                            <p class="font-ks font-16 weight-500 lineh-26 margin-b20 color-30"><span class="weight-700 color-29">Our Mission:</span> is to build and deliver impeccable financial services to the industry through excellence..</p>
                            <p class="font-ks font-16 weight-500 lineh-26 color-30"><span class="weight-700 color-29">VALUES:</span>are based on serving our customers in the best possible manner and these are: <br>
Integrity <br>
Quality <br>
Professionalism</p>
                        </div>
...
Professionalism</p>
                      ...
                      <a href="services.php" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Get Started Now <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="vissionimages">
                    <img src="assets/images/sectionimg/vissionimg.png" alt="">
                    <img src="assets/images/elementor/elementor17.png" alt="" class="elementor-23 keyframe3">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="cta5-auhtor6-area">
          <h1 class="font-lora font-48 lineh-52 color weight-600 margin-b text-capitalize">NEED ANY HELP AT YOUR TAX SOLUTION?</h1>
          <p class="font-ks font-16 lineh-26 weight-500 color-21">CTA Tax and Business Services is an accounting firm that provides various services in the broad accounting and financing field. CTA provides a multitude of services to a wide variety of clients from its presence in Pretoria.</p>
        </div>
      </div>
      ...
      <div class="col-lg-12">
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="contact5-logo5-text">
                <img src="assets/images/logo/logo15.png" alt="">
                <p class="font-ks font-16 weight-500 lineh-26 color32 margin-t margin-b24">CTA Tax and Business services is an accounting firm that provides various services in the broad accounting and financing field</p>
            ...
            <div class="col-lg-3 col-md-6">
              <div class="contact-footer heightleft">
                ...
                <div class="email4">
                    <img src="assets/images/icons/email4.svg" alt="">
                    <a href="mailto:info@ctaaccountants.co.uk" class="font-16 lineh-24 color32 weight-400 font-ks">info@ctaaccountants.co.uk</a>
                </div>
                <span class="location-fooetr ">
                  <img src="assets/images/icons/location2.png" alt="" class="heightwidth">
                <a href="#" class="font-16 font-ks lineh-26 weight-500 color32 margin-t">30 Stanwick Gardens, Cheltenham Gloucestershine,<br> United Kingdom, Post GL51 9LF<br> </a>
                </span>
                <div class="email4 mazrgin-t">
                    <img src="assets/images/icons/phone5.svg" alt="">
                    <a href="tel:+447754057397" class="font-16 lineh-24 color32 weight-400 font-ks">+447754057397</a>
                </div>
            </div>
            </div>
        ...
        <div class="border10"></div>
          <div class="copyright6 text-center">
            <p class="font-ks lineh-26 weight-500 font-16 color32">© Copyright 2024 CTA</p>
          </div>
      </div>
    </div>
  </div>

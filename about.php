    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="welcomeaboiut2 text-center">
                ...
                <p class="font-20 weight-500 font-ks lineh-20 color"><a href="index.html" class="color">Home</a><span><i class="fa-solid fa-angle-right"></i></span> About Us</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="lawprovide-textarea">
                    ...
                    <a href="team.html" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Meet Our Attorneys <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="missiontextarea">
                    ...
                    <a href="services.html" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Learn More <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
        </div>
    </div>
...
Professionalism</p>
                      ...
                      <a href="services.html" class="theme6-btn6 font-ks lineh-16 weight-700 color font-16 margin-t32">Get Started Now <span><i class="fa-solid fa-arrow-right"></i></span></a>
                </div>
            </div>
            <div class="col-lg-6">

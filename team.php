...
<!--===== TEAM STARTS=======-->
<div class="team-innerpages-area section-padding8">
    <div class="container">

        <div class="row">
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
            ...
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
                    <div class="project-item-two">
                        <div class="project-thumb-two">
                            <img src="assets/images/team/Mr. Muyideen Alabi (Legal).jpg" alt="">
                        </div>
                        <div class="project-content-two">
                            <ul>
                              <li><a href="#"><i class="fa-brands fa-x-twitter"></i>
            ...
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
                    <div class="project-item-two">
                        <div class="project-thumb-two">
                            <img src="assets/images/team/Cynthia Radebe - Office Manager.jpg" alt="">
                        </div>
                        <div class="project-content-two">
                            <ul>
                              <li><a href="#"><i class="fa-brands fa-x-twitter"></i>
            ...
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
                    <div class="project-item-two">
                        <div class="project-thumb-two">
                            <img src="assets/images/team/Dumsile Mamba - Accountant.jpg" alt="">
                        </div>
                        <div class="project-content-two">
                            <ul>
                              <li><a href="#"><i class="fa-brands fa-x-twitter"></i>
            ...
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
                    <div class="project-item-two">
                        <div class="project-thumb-two">
                            <img src="assets/images/team/Nthabiseng Gebashe - Accountant.jpg" alt="">
                        </div>
                        <div class="project-content-two">
                            <ul>
                              <li><a href="#"><i class="fa-brands fa-x-twitter"></i>
            ...
            <div class="col-lg-3 margin-b30">
                <div class="teaminner-section">
                    <div class="project-item-two">
                        <div class="project-thumb-two">
                            <img src="assets/images/team/Paula Matema - Bookkeeper.jpg" alt="">
                        </div>
                        <div class="project-content-two">
                            <ul>
                              <li><a href="#"><i class="fa-brands fa-x-twitter"></i>
...
<!-- Mirrored from html.fleexstudio.com/consult/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2023 12:21:51 GMT -->
</html>
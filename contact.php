    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="welcomeaboiut2 text-center">
                <h1 class="font-lora font-60 lineh-64 weight-500 color margin-b24">Contact Us</h1>
                <p class="font-20 weight-500 font-ks lineh-20 color"><a href="index.html" class="color">Home</a><span><i class="fa-solid fa-angle-right"></i></span>Contcat Us</p>
            </div>
        </div>
    </div>
</div>
...
<!--===== CONTACT STARTS=======-->
<div class="cotactinner-section-area section-padding5">
  <div class="container">
    <div class="row align-items-center">
      <div class="col-lg-6">
        <div class="contcat5-textarea5">
          ...
          <div class="phone7-textarea margin-t32 contactinnerbg"> 
            ...
            <div class="phone7-text">
              ...
              <a href="tel:+447754057397" class="font-lora font-24 weight-700 lineh-24 color-29">+447754057397</a>
            </div>
          </div>

          <div class="phone7-textarea margin-t contactinnerbg">
            <div class="phone7-icon">
              <img src="assets/images/icons/email7.png" alt="">
            </div>
            <div class="phone7-text">
              <p class="font-16 lineh-16 weight-500 font-ks color-30 margin-b">Send me Mail</p>
              <a href="mailto:info@ctaaccountants.co.uk" class="font-lora font-24 weight-700 lineh-24 color-29">info@ctaaccountants.co.uk</a>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="accordion-item bordernone">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <p class="font-ks font-16 lineh-26 weight-500 color-22 ">Our consulting process involves four key steps: Discovery, Strategy, Implementation, and Sustainment. We start by understanding your challenges and goals, then craft a customized strategy.</p>
                  </div>
                </div>
              </div>
              <div class="accordion-item bordernone">
                ...
                <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                    <p class="font-ks font-16 lineh-26 weight-500 color-30 ">Our consulting process involves four key steps: Discovery, Strategy, Implementation, and Sustainment. We start by understanding your challenges and goals, then craft a customized strategy.</p>
                  </div>
                </div>
              </div>
              <div class="accordion-item bordernone">
                ...
                <div class="accordion accordian4" >
                  <div class="accordion-item bordernone">
                    ...
                    <div id="collapseFive" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="font-ks font-16 lineh-26 weight-500 color-22 ">Yes, we offer expertise in talent acquisition and team building to your strategies. We understand that a strong team is essential for business success and can provide guidance on hiring the right talent </p>
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item bordernone">
                    ...
                    <div id="collapseSix" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                        <p class="font-ks font-16 lineh-26 weight-500 color-30 ">Yes, we offer expertise in talent acquisition and team building to your strategies. We understand that a strong team is essential for business success and can provide guidance on hiring the right talent </p>
                      </div>
                    </div>
                  </div>
                  <div class="accordion-item bordernone">
...
<!-- Mirrored from html.fleexstudio.com/consult/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 29 Dec 2023 12:21:55 GMT -->
</html>